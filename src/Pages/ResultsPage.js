...
const images = [
  require("../assets/scenic1.jpeg"),
  require("../assets/background1.jpg"),
  require("../assets/nightsky.jpeg"),
];
var imgIndex = 0;
var example = [
  {
